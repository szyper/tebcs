...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Cze 2023, 14:52
...
(2, 1, 1, '127.0.0.1', '2023-06-12 10:12:55'),
(3, 1, 0, '127.0.0.1', '2023-06-12 10:14:24'),
(4, 2, 0, '127.0.0.1', '2023-06-12 10:14:31'),
(5, 2, 1, '127.0.0.1', '2023-06-12 10:14:34'),
(6, 1, 1, '127.0.0.1', '2023-06-12 10:14:53'),
(7, 1, 1, '127.0.0.1', '2023-06-12 11:31:10');
...
CREATE TABLE `users` (
  ...
  `role_id` tinyint(10) UNSIGNED NOT NULL DEFAULT 1,
...
INSERT INTO `users` (`id`, `cities_id`, `role_id`, `email`, `additional_email`, `firstName`, `lastName`, `birthday`, `logo`, `password`, `created_at`) VALUES
(1, 853, 3, 'admin@o2.pl', '', 'Janusz', 'Nowak', '2023-12-31', 'user1-128x128.jpg', '$argon2id$v=19$m=65536,t=4,p=1$WDVJNWNpaHAvaFhTdXN4Sg$r8AOuCqWIw2SzLonKRfwgjB88TOgRF9dx+uAFTpr8A8', '2023-06-05 08:49:16'),
(2, 1, 1, 'user@o2.pl', 'user@o2.pl2', 'Krystyna', 'Pawlak', '2021-12-31', 'user7-128x128.jpg', '$argon2id$v=19$m=65536,t=4,p=1$QUguQTAuSmwzbTYzTlJ2TA$1CdIOLXsi8zOsaUWARwKfa/DfgGXcX9TLjd5/sD2i3w', '2023-06-05 08:49:53');
